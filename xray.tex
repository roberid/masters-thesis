...
\begin{figure}[!tp]
  ...
  \caption[Star-forming and disc fractions versus stellar mass for
    galaxies outside their host X-ray radius and for different halo
    mass bins and the two $L_X$ samples]{Star-forming (solid lines) and disc (dashed lines)
...
\begin{figure}[!tp]
  ...
  \caption[Star-forming and disc fractions versus stellar mass for
    galaxies inside their host X-ray radius and for different halo
    mass bins and the two $L_X$ samples]{Same as Fig.~\ref{fig:disk_sfFrac_w_lx2_mh_rxh} for
...
\begin{figure}[!tp]
  ...
  \caption[SF and disc excess versus stellar mass for both galaxies
    within and outside of the X-ray radius]{SF and disc excess versus
    stellar mass for both galaxies 
